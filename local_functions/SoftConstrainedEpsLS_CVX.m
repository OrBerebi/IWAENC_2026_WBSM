function C = SoftConstrainedEpsLS_CVX(V, h, omega_V, omega_sector, target_nmse_db,lambda)
...
for f = 1:F
    ...
    cvx_begin quiet
        ...
        variable slack_nonneg
        minimize( ...
            sum_square_abs(Vs' * c - hs) + ...
            lambda * slack_nonneg ...
        )
        subject to
            sum_square_abs(Vo' * c - ho) - epsilon <= slack_nonneg
            slack_nonneg >= 0
    cvx_end
