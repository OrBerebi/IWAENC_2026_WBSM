    ...
    switch lower(typeString)
        ...
        case 'hutubs'
            if ~exist('pp1_HRIRs_measured.sofa', 'file')
                error('AKtools:dependencies', 'This part of AKtools needs the HRIR databaseinside the Matlab search path. It is available from www.depositOnce.tu-berlin.de');
            end
        otherwise
